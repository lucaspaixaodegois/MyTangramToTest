...
public class Renderizador implements GLSurfaceView.Renderer, GLSurfaceView.OnTouchListener {
...
//rabo
        ...
        paralelogramo1.setCor(0,0,1,1);
        paralelogramo1.setCor(0, 0, 1, 1);
        paralelogramo1.setRotation(1);

        //teste touch
        quadrado2 = new Quadrado(gl, 120);
        quadrado2.setCor(0, 1, 0, 1);
        quadrado2.setRotation(0);
    ...
    @Override
    public boolean onTouch(View superficieDesenho, MotionEvent event) { //metodo chamado para utilizar  o touch evento
